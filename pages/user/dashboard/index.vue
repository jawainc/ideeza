  ...
  <div :class="{'hide-left-bar':!leftMenu}" class="flex main-panel">
    ...
    <div class="flex-grow lg:pt-10 lg:px-2  mb-20">
      ...
      <div class="mt-10 orders">
        <h1 class="text-xl font-semibold text-gar-800 pl-3 lg:pl-0 pb-3 mb-3 border-b border-solid border-gary-300">New Orders</h1>
        <div>
        ...
        <table>
          ...
          <tbody>
            ...
            <td class="lg:text-right">
              <button class="btn btn-normal px-1 block bg-white mb-3 lg:float-right">Invoice</button>
              <button class="btn btn-normal px-1 block bg-white lg:float-right">Details</button>
            </td>
          </tr>
          </tbody>
        </table>

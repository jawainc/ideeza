        ...
        <div class="detail-main">
          ...
          <div class="flex justify-between flex-col lg:flex-row border-b border-gray-400 pl-5 pr-5 lg:pl-0 lg:pr-0 pb-3">
            ...
            <div class="flex flex-wrap items-center">
              <nuxt-link to="/user/profile" class="btn btn--ideeza px-6 py-1 mr-5">
                Publish <font-awesome-icon class="ml-5 h-6 text-xl" :icon="['fas', 'star']"/>
              </nuxt-link>
          ...
          <div class="my-5 bg-white shadow">
            ...
            <div class="py-5 px-5 lg:flex justify-between items-center">
              <div class="flex">
                <div class="mr-5 font-semibold text-gray-500 cursor-pointer text-sm">
                  <font-awesome-icon class="mr-1 h-4" :icon="['fas', 'plus']"/>
                  Add To
                </div>
                <div class="mr-5 font-semibold text-gray-500 cursor-pointer text-sm">
                  <font-awesome-icon class="mr-1 h-4" :icon="['fas', 'code']"/>
                  Embed
                </div>
                <div class="mr-5 font-semibold text-gray-500 cursor-pointer text-sm">
                  <font-awesome-icon class="mr-1 h-4" :icon="['fas', 'share']"/>
                  Share
                </div>
              </div>
          ...
          <div class="my-10 bg-white shadow">
            <div class="flex py-5 border-b border-solid border-gray-300">
              <div @click="tab=0" class="tab px-5 text-gray-700 font-semibold text-lg lg:text-xl cursor-pointer"
                   :class="{'active': tab===0}">
                Description
              </div>
              <div @click="tab=1" class="tab px-5 text-gray-700 font-semibold text-lg lg:text-xl cursor-pointer"
                   :class="{'active': tab===1}">
                Project Information
              </div>
            </div>
